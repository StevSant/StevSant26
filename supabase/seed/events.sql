INSERT INTO event (assisted_at, is_archived, is_pinned, position)
VALUES
-- Supabase Launch Week #15
('2025-07-16', false, false, 1),

-- Invitación aniversario Viamatica (HackIAthon winners)
('2025-08-28', false, true, 2),

-- Supabase + Club IA ULEAM Pitch Day
('2025-09-25', false, true, 3),

-- Cursor Meetup Manta
('2025-10-16', false, false, 4),

-- ULEAM Tech Fest 2025
('2025-11-06', false, true, 5),

-- Supabase Workshop
('2025-12-06', false, true, 6);
...
-- ======================
(
  (SELECT id FROM event WHERE assisted_at = '2025-07-16'),
...
-- ======================
(
  (SELECT id FROM event WHERE assisted_at = '2025-08-28'),
  (SELECT id FROM language WHERE code = 'es'),
...
-- ======================
(
  (SELECT id FROM event WHERE assisted_at = '2025-09-25'),
  (SELECT id FROM language WHERE code = 'es'),
...
-- ======================
(
  (SELECT id FROM event WHERE assisted_at = '2025-10-16'),
  (SELECT id FROM language WHERE code = 'es'),
  'Cursor Meetup – Manta',
...
-- ======================
(
  (SELECT id FROM event WHERE assisted_at = '2025-11-06'),
  (SELECT id FROM language WHERE code = 'es'),
  'ULEAM Tech Fest 2025',
...
-- ======================
(
  (SELECT id FROM event WHERE assisted_at = '2025-12-06'),
  (SELECT id FROM language WHERE code = 'es'),
  'Supabase Workshop',
