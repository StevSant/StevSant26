-- =============================================
-- Auto-generate `code` for entity tables when not provided
-- =============================================
-- This trigger auto-generates a unique code (table_name + id)
-- when the frontend creates entities without specifying a code.
-- Seed files that provide explicit codes are unaffected.
-- =============================================
